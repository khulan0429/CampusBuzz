...
<body>
  ...
  <div class="breadcrumb">
    ...
    <span>/</span>
    <a href="lol.jsp">Health</a>
    <span>/</span>
    <span>About Health Insurance</span>
  </div>

  <section class="design" id="design">
    <div class="container">
      <h2>About Health Insurance</h2>
      <p>Do we really need to pay?</p>
    </div>
    <div class="design-content">
      <%
        try {
          Connection con = ConnectionProviderClass.getCon();
          String query = "SELECT * FROM posts WHERE category='About Health Insurance'";
