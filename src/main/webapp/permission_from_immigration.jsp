...
<body>
  ...
  <div class="breadcrumb">
    ...
    <span>/</span>
    <a href="lol.jsp">Career Quest</a>
    <span>/</span>
    <span>Permission from Immigration </span>
  </div>

  <section class="design" id="design">
    <div class="container">
      <h2>Career Quest</h2>
      <p>Permission from Immigration </p>
    </div>
    <div class="design-content">
      <%
        try {
          Connection con = ConnectionProviderClass.getCon();
          String query = "SELECT * FROM posts WHERE category='Permission from Immigration '";
